...
$valid_sort_options = ['name_e', 'price_e', 'rate_e'];
if(!in_array($sort_option, $valid_sort_options)) {
  $sort_option = 'name_e';
}


$sql_query = "SELECT * FROM `bookinfo` ORDER BY $sort_option";
...
<body>
  ...
  <form action="" method="get">
      <select id="sort-options" name="sort">
        <option value="name_e" <?php if($sort_option == 'name_e') echo 'selected'; ?>>নাম অনুসারে সাজান</option>
        <option value="price_e" <?php if($sort_option == 'price_e') echo 'selected'; ?>>মূল্য অনুসারে সাজান</option>
        <option value="rate_e" <?php if($sort_option == 'rate_e') echo 'selected'; ?>>রেটিং অনুসারে সাজান</option>
      </select>
